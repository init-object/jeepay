pipeline {
    parameters {
        ...
        booleanParam(name: 'build_jeepay_payment', defaultValue: true, description: '是否构建jeepay-payment')
        booleanParam(name: 'build_jeepay_manager', defaultValue: true, description: '是否构建jeepay-manager')
        booleanParam(name: 'build_jeepay_merchant', defaultValue: true, description: '是否构建jeepay-merchant')
        booleanParam(name: 'build_jeepay_activemq', defaultValue: false, description: '是否构建activeMq')
    ...
    environment {
        ...
        ACTIVEMQ_APP_NAME = 'jeepay-activemq'
        GITHUB_URL = 'git@github.com:init-object/jeepay.git'
